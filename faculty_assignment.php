							...
							<table id="ongoing-assign-table" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
									<tr data-assignment-id="assign1">
										<th scope="row">1</th>
										<td>MIPS Programming <button class="btn btn-outline-primary">Edit <i class="fa fa-edit"></i></button>
										</td>
										<td>28-12-2017</td>
										<td>28-12-2017</td>
									</tr>
									<tr data-assignment-id="assign2">
										<th scope="row">2</th>
										<td>Pipelining <button class="btn btn-outline-primary">Edit <i class="fa fa-edit"></i></button>
										</td>
										<td>28-12-2017</td>
										<td>28-12-2017</td>
									</tr>
