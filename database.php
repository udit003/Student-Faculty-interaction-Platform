...
<?php
	...
	if ($conn->query($sql0) === TRUE) {
		echo "Successfully dropped previous database <br>";
	} else {
		echo "Error dropping previous database: " . $conn->error . "<br>";
	}
	...
	if ($conn->query($sql2) === TRUE) {
		echo "Successfully accessed database <br>";
	} else {
		echo "Error accessing database:" . $conn->error . "<br>";
	}	
   // successfully entered into STIP database
	...
	if ($conn->query($sql1) === TRUE) {
		echo "departments created successfully <br>";
	} else {
	...
	if ($conn->query($sql1) === TRUE) {
		echo "user_table created successfully <br>";
	} else {
		echo "Error creating table: " . $conn->error . "<br>";
	}
	...
	if ($conn->query($sql1) === TRUE) {
		echo "courses created successfully <br>";
	} else {
		echo "Error creating table: " . $conn->error . "<br>";
	}
	...
	if ($conn->query($sql1) === TRUE) {
		echo "user_courses created successfully <br>";
	} else {
		echo "Error creating table: " . $conn->error . "<br>";
	}
	...
	if ($conn->query($sql1) === TRUE) {
		echo "assignments created successfully <br>";
	} else {
		echo "Error creating table: " . $conn->error . "<br>";
	}
	...
	$sql1 ="create table user_assignments(user_id int , assignment_id int , submission__status enum('saved', 'submitted') , grade varchar(5) default '--', assignment_solution TEXT , 
		...
		if ($conn->query($sql1) === TRUE) {
		echo "user_assignments created successfully <br>";
	} else {
		echo "Error creating table: " . $conn->error . "<br>";
	}
